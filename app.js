...
let recipes = [
{
  ...
  category: "dessert",
  image: "chia berry pudding.png",
  description: "Light, creamy chia pudding with berries.",
  ingredients: [ "3 tbsp chia seeds", "1 cup unsweetened almond milk", "1/2 cup mixed berries", "1 tsp honey or maple syrup"],
  steps: [ "Mix chia seeds with almond milk and sweetener. Refrigerate 2–4 hours.", "Once thickened, top with fresh berries.", "Serve chilled."],
  nutrition: { Calories: 180, Protein: "6 g", Carbs: "20 g", Fat: "8 g", Fiber: "10 g" }
},

{
  ...
  description: "Fiber-packed, satisfying tacos with avocado.",
  ingredients: [ "2 small sweet potatoes, diced", "1 cup black beans, drained", "4 small whole wheat tortillas", "1/2 avocado, sliced", "1 tsp cumin", "Salt and pepper to taste"
  ],
  steps: [ "Roast sweet potatoes with olive oil, cumin, salt, and pepper at 200°C for 25 minutes.", "Warm tortillas and fill with roasted sweet potatoes and black beans.", "Top with avocado slices and serve."
  ],
  nutrition: { Calories: 400, Protein: "12 g", Carbs: "60 g", Fat: "12 g", Fiber: "15 g" }
},
